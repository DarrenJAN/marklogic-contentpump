...
- Remove the mapr profile as it is no longer in use.
- Upgrade Hadoop Library to 3.4.0. 
- Upgrade Jena Version to 4.9.0.
- Upgrade commons-compress, woodstox-core, hadoop-shaded-guava, xstream, commons-logging,
commons-io, xml-apis, avro, commons-collections and other related libraries.
